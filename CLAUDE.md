Most of the times it's not necessary to build the site, because the local development uses `npm run site:dev` script which rebuilds the site on every change.
